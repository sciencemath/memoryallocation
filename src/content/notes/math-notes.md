...
example:
S*-2^0 S_1^4 S*-x^0 4z - 2y dz dx dy
S*-2^0 S_1^4 [4z^2/2 - 2zy] -x to 0
= 0 - (4x^2/2 + 2xy)
= S*-2^0 S_1^4 -2x^2 - 2xy dx dy

second layer
S*-2^0 S_1^4 -2x^2 - 2xy dx dy
= S*-2^0 [-2x^3/3 - x^2y] | 1 to 4
= S*-2^0 (-128/3 - 16y) - (-2/3 - y)
= S*-2^0 -42 - 15y dy

third layer
S*-2^0 -42 - 15y dy
= S*-2^0 [-42y - 15y^2/2] | -2 to 0
= (0) - (84 - 60/2)
= -84 + 30
= -54
...
example:
S*-3^1 S_1^2 S_0^4 y^2 - xz dy dx dz
= S*-3^1 S*1^2 [y^3/3 - yxz] | 0 to 4
= S*-3^1 S*1^2 (64/3 - 4xz)
= S*-3^1 S_1^2 64/3 - 4xz dx dz

second layer
S*-3^1 S_1^2 64/3 - 4xz dx dz
= S*-3^1 [64/3(x) - 2x^2z] | 1 to 2
= S*-3^1 (128/3 - 8z) - (64/3 - 2z)
= S*-3^1 64/3 - 6z dz
...
example:
S*-1^1 S_0^2 S_0^(z^2) x + 2y - 2z dx dz dy
= S*-1^1 S*0^2 [x^2/2 + 2xy - 2xz] | 0 to z^2
= S*-1^1 S*0^2 (z^4/2 + 2z^2y - 2z^3) - (0)
= S*-1^1 S_0^2 z^4/2 + 2yz^2 - 2z^3 dz dy

second layer
S*-1^1 S_0^2 z^4/2 + 2yz^2 - 2z^3 dz dy
= S*-1^1 [z^5/10 + 2yz^3/3 - z^4/2] | 0 to 2
= S*-1^1 (32/10 + 16y/3 - 16/2) - (0)
= 32/10 - 80/10 = -48/10 = -24/5
= S*-1^1 16y/3 - 24/5

third layer
S\_-1^1 16y/3 - 24/5 dy
...
S*0^2pi S_0^1 S*?^? r dz dr dtheta.
...
S*0^2pi S_0^1 S*-sqrt(1-r^2)^sqrt(1-r^2) r dz dr dtheta
...
S*-pi/2^pi/2 S_0^2pi cos^2(t)cos^2(s)cos(t) ds dt
= SS cos^3(t)cos^2(s) ds dt
= (S*-pi/2^pi/2 cos^3(t) dt) (S_0^2pi cos^2(s) ds)
...
= S*-pi/2^pi/2 (cos(t) - cos(t)sin^2(t)) dt S_0^2pi (1/2 + 1/2(cos2(s))) ds
= S*-pi/2^pi/2 [sin(t) - sin^3t/3] | -pi/2 to pi/2
= (1 - 1/3) - (-1 + +1/3)
= 2/3 + 2/3
= 4/3
...
= 2/3 * sqrt(2)/4 = 1/3 _ sqrt(2)/2
= 1/3 _ sqrt(2)/2 [(1 + 2v^2)^(3/2)] | 0 to 2
= sqrt(2)/6(27 - 1)
= 26sqrt(2)/6
= 13sqrt(2)/3
...
= S*-2^2 S*(x^2 - 4)(x^2 - 1)^(4 - x^2)

since its clockwise we have to make this negative:
-(∂Q/∂x - ∂P/∂y) = ∂P/∂y - ∂Q/∂x

= S*-2^2 (S*(x^2 - 4)(x^2 - 1)^(4 - x^2) (∂P/∂y - ∂Q/∂x) dy) dx
= S*-2^2 (S*(x^2 - 4)(x^2 - 1)^(4 - x^2) (x^2 - 0) dy) dx <- factored
= S*-2^2 (x^2 S*(x^2 - 4)(x^2 - 1)^(4 - x^2) dy) dx
= S*-2^2 x^2 ((4 - x^2) - (x^2 - 4)(x^2 -1)) dx
= S*-2^2 x^2 (4 - x^2)(-1 - (x^2 - 1)) dx
= S*-2^2 -x^4(x^2 - 4) dx
= S*-2^2 -(x^6 - 4x^4) dx
= S\_-2^2 4x^4 - x^6 dx
...
S\_-infinity^infinity D(t - c) dt = 1
...
Convolution Theorem (_) = convolution symbol in this context
(w/ Laplace tranform)
L{f(t)} = F(s)
L{g(t)} = G(s)
L{(f _ g)(t)} = F(s)G(s)
...
example:
2s/(s^2 + 1)^2
= 2 _ 1/(s^2 + 1) _ s/(s^2 + 1)
= L^-1{2 _ 1/(s^2 + 1) _ s/(s^2 + 1)}
...
- fourth x
  ...
  Performing the A^TA^-1 _ A^T first then A
  2x2 and the 2x4 matrix should have a 2x4
  [
  2 -1 0 1
  -1 2 0 1
  ]
  lets use this and dot it with A (above) A is a 4x2 and A^TA^-1 _ A^T is 2x4 so we should have a 4x4 matrix
  = 1/3 _ [
  2 -1 0 1
  -1 2 0 1
  0 0 0 0
